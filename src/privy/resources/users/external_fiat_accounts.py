...
from ...types.users import external_fiat_account_list_params, external_fiat_account_create_params
from ..._base_client import make_request_options
from ...types.environment import Environment
from ...types.success_response import SuccessResponse
from ...types.orchestration_provider import OrchestrationProvider
from ...types.external_fiat_account_response import ExternalFiatAccountResponse
...
from ...types.list_external_fiat_accounts_response import ListExternalFiatAccountsResponse
...
class ExternalFiatAccountsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          user_id: The DID of the user to create the external fiat account for.
        ...
        return self._post(
            path_template("/v1/users/{user_id}/external_fiat_accounts", user_id=user_id),
            ...
            cast_to=ExternalFiatAccountResponse,
        )
    ...
    def list(
        ...
        *,
        ...
        Args:
          user_id: The DID of the user to list external fiat accounts for.
        ...
        return self._get(
            ...
            cast_to=ListExternalFiatAccountsResponse,
        )
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            path_template(
                "/v1/users/{user_id}/external_fiat_accounts/{account_id}", user_id=user_id, account_id=account_id
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),

...
__all__ = ["WalletActionEarnDepositFailedWebhookPayload"]


class WalletActionEarnDepositFailedWebhookPayload(BaseModel):
    ...
    type: Literal["wallet_action.earn_deposit.failed"]

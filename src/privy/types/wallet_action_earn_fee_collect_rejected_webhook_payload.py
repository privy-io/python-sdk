...
__all__ = ["WalletActionEarnFeeCollectRejectedWebhookPayload"]


class WalletActionEarnFeeCollectRejectedWebhookPayload(BaseModel):
    ...
    type: Literal["wallet_action.earn_fee_collect.rejected"]

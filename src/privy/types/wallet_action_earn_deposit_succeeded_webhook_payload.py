...
__all__ = ["WalletActionEarnDepositSucceededWebhookPayload"]


class WalletActionEarnDepositSucceededWebhookPayload(BaseModel):
    ...
    type: Literal["wallet_action.earn_deposit.succeeded"]
    ...
    """Human-readable decimal amount of asset deposited (e.g.

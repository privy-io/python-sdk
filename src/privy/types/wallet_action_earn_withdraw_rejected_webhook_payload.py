...
__all__ = ["WalletActionEarnWithdrawRejectedWebhookPayload"]


class WalletActionEarnWithdrawRejectedWebhookPayload(BaseModel):
    ...
    type: Literal["wallet_action.earn_withdraw.rejected"]

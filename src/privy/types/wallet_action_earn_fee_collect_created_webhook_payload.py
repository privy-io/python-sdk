...
__all__ = ["WalletActionEarnFeeCollectCreatedWebhookPayload"]


class WalletActionEarnFeeCollectCreatedWebhookPayload(BaseModel):
    ...
    type: Literal["wallet_action.earn_fee_collect.created"]

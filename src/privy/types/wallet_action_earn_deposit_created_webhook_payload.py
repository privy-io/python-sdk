...
__all__ = ["WalletActionEarnDepositCreatedWebhookPayload"]


class WalletActionEarnDepositCreatedWebhookPayload(BaseModel):
    ...
    type: Literal["wallet_action.earn_deposit.created"]

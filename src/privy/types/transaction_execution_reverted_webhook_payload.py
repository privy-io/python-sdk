...
__all__ = ["TransactionExecutionRevertedWebhookPayload"]


class TransactionExecutionRevertedWebhookPayload(BaseModel):
    ...
    type: Literal["transaction.execution_reverted"]

...
__all__ = ["WalletActionEarnDepositRejectedWebhookPayload"]


class WalletActionEarnDepositRejectedWebhookPayload(BaseModel):
    ...
    type: Literal["wallet_action.earn_deposit.rejected"]

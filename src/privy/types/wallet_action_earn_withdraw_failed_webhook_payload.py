...
__all__ = ["WalletActionEarnWithdrawFailedWebhookPayload"]


class WalletActionEarnWithdrawFailedWebhookPayload(BaseModel):
    ...
    type: Literal["wallet_action.earn_withdraw.failed"]

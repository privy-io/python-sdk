...
__all__ = ["WalletActionEarnFeeCollectSucceededWebhookPayload"]


class WalletActionEarnFeeCollectSucceededWebhookPayload(BaseModel):
    ...
    type: Literal["wallet_action.earn_fee_collect.succeeded"]
